# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 11:01:36 2024
...
# Load the dataset
file_path = r"C:\Users\affu4\Downloads\drive-download-20240806T044506Z-001\laptop_cleaned2.csv"
data = pd.read_csv(file_path)

# Handle missing values for numerical columns with the median
numerical_columns = ['Processor_gen', 'Core_per_processor', 'Total_processor', 
                     'Execution_units', 'Threads', 'Graphics_GB']
for column in numerical_columns:
    data[column].fillna(data[column].median(), inplace=True)

# Handle missing values for categorical columns with the mode
categorical_columns = ['RAM_type', 'Graphics_name', 'Graphics_brand', 
                       'Graphics_integreted', 'Processor_variant']
