# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 11:58:17 2024
...
ecommerce_data_path = r"C:\Users\affu4\Downloads\drive-download-20240806T044506Z-001\ecommerce_product_dataset2.csv"
...
boolean_cols = ecommerce_data.select_dtypes(include=['bool']).columns

# Convert boolean columns to integer (True to 1, False to 0)
ecommerce_data[boolean_cols] = ecommerce_data[boolean_cols].astype(int)
...
ecommerce_data['Stock In Vast or Limited Quantity'] = ecommerce_data['Stock In Vast or Limited Quantity'].replace({'TRUE': 1, 'FALSE': 0})

# Convert to integers
ecommerce_data['Stock In Vast or Limited Quantity'] = ecommerce_data['Stock In Vast or Limited Quantity'].astype(int)
...
new_data = pd.DataFrame({
    ...
    'City': ['Albuquerque'],
    'Stock In Vast or Limited Quantity': [1]
})

# Convert boolean columns to integer in new data
new_data[boolean_cols] = new_data[boolean_cols].astype(int)
